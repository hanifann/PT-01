...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container mt-4" id="tiba">
      ...
      <div class="container mt-3">
        <div class="row" style="color:#777777;">
          ...
          <div class="col-3">
            <a href="#" style="border-bottom:3px solid #3FC0B7;" id="tibaa">Pesanan Tiba</a>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
    $(document).on("click","#diproses",function() {
      $("#tiba").load("tunggu.php #proses");
    });

    $(document).on("click","#dikirim",function() {
      $("#tiba").load("kirim.php #kirim");
    });
  </script>
  <!-- Footer -->
  <footer id="myFooter">
